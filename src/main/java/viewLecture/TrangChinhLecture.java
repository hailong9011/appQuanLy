...
import controller.TabViewLecture;
...
public class TrangChinhLecture extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TrangChinhLecture frame = new TrangChinhLecture(user);
	 ...
	 * Create the frame.
	 */
	public TrangChinhLecture(User user) {

		TrangChinhLecture.user = user;
		...
		panelManage.setBounds(11, 287, 265, 83);
		...
		TabViewLecture chuyenTab = new TabViewLecture(panelView, user);
		chuyenTab.addView(panelHome);

		List<TabSelect> listItem = new ArrayList<>();
		listItem.add(new TabSelect("TrangChuLecture", panelHome));
		listItem.add(new TabSelect("QuanLyHocLieuLecture", panelManage));
		listItem.add(new TabSelect("ThongTinTaiKhoanLecture", panelInfo));
		...
		JLabel lblNewLabel_1_3 = new JLabel("Thông Tin Cá Nhân");
		lblNewLabel_1_3.setBounds(0, 0, 265, 83);
		panelInfo.add(lblNewLabel_1_3);
